...
def seed():
    with app.app_context():
        ...
        sec_b = Section(name="Sec B", batch_id=batch_23.id, student_count=25)
        ...
        lab_course = Course(name="IT Lab", code="IT102", credits=2, department_id=it_dept.id, course_type="Lab")
        ...
        # Availability: Only available Monday and Tuesday morning slots
        ...
        room102 = Room(name="Room 102", capacity=30, room_type="Classroom") # Small room
